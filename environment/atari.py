...
class atari(object):
    ...
    def __init__(self, game_name, n_stack=4):
        ...
        self.valid_action = self.env.env._action_space
    ...
    def step(self, action):
        # z = self.env.step(action)
        # print(z)
        obs, r, terminal, unknown_boolean, info = self.env.step(action)
        ...
        # print("The lives are:", info.keys())
        k = "lives"
        if self.lives > info[k] and info[k] > 0:
